...
\begin{frame}
    ...
    \begin{align*}
        ...
        \frac{\partial \log \pi_k(\boldsymbol{x}_i;\boldsymbol{w})}{\partial w_{ki}} & =b_i(\boldsymbol{x}_i)-\frac{1}{1+\sum\limits_{g=1}^{L-1}\exp\left\{\boldsymbol{w}_g^T\boldsymbol{b}(\boldsymbol{x}_i)\right\}}                          \\
...
\begin{frame}
    ...
    同様の議論により
    \begin{align*}
        \frac{\partial}{\partial w_{ki}}\log \pi_l(\boldsymbol{x}_i;\boldsymbol{w})=
    \end{align*}
\end{frame}
\end{document}
